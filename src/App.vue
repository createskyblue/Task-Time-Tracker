  ...
  <el-container>
      ...
      <div class="p-4">
        ...
        <div class="project-list">
          <div v-for="task in tasks" :key="task.id"
            ...
            :class="{'bg-gray-100': selectedTask?.id === task.id}"
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center space-x-2">
                <el-button v-if="!isTaskRunning(task.id)" 
    ...
    <el-container>
      <el-main class="pt-5">
          ...
          <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center space-x-2">
              <el-button type="primary" @click="startTimer(selectedTask.id)" 
                :disabled="isTaskRunning(selectedTask.id)">
                让我们开始
              </el-button>
		...
		<el-input 
		  v-model="taskDescriptions[selectedTask.id]" 
		  type="textarea" 
		  :rows="10"
		  placeholder="请输入任务说明" 
		  class="mb-4"
        ...
        <!-- 时间统计 -->
		<div class="mt-1 rounded-lg border border-gray-200 bg-white shadow-sm">
		  <!-- Header -->
        ...
        <!-- 时间线 -->
        <div class="mt-6 p-5 border border-gray-200 rounded-lg shadow-sm">
          <div v-if="!selectedTask">
